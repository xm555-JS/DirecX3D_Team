...
CVIBuffer_Terrain_Tess::CVIBuffer_Terrain_Tess()
	: CVIBuffer()
{
}
...
HRESULT CVIBuffer_Terrain_Tess::Initialize_Prototype(const _tchar* pHeightMapFilePath)
{
	_ulong			dwByte = 0;
...
HRESULT CVIBuffer_Terrain_Tess::Initialize(void * pArg)
{
	return S_OK;
}

CVIBuffer_Terrain_Tess * CVIBuffer_Terrain_Tess::Create(const _tchar* pHeightMapFilePath)
{
	CVIBuffer_Terrain_Tess*			pInstance = new CVIBuffer_Terrain_Tess();
...
CComponent * CVIBuffer_Terrain_Tess::Clone(void * pArg)
{
