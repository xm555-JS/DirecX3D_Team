...
BEGIN(Client)
class CCursor;
class CEnemy_Boss_Leviathan_90m final : public CEnemy_Boss
{
public:
	CEnemy_Boss_Leviathan_90m();
	CEnemy_Boss_Leviathan_90m(const CEnemy_Boss& rhs);
	virtual ~CEnemy_Boss_Leviathan_90m() = default;
...
public:
	static CEnemy_Boss_Leviathan_90m* Create();
