...
BEGIN(Client)
class CBullet_Player_Cube_Main final : public CBullet
{
public:
...
public:
	CBullet_Player_Cube_Main();
	CBullet_Player_Cube_Main(const CBullet_Player_Cube_Main& rhs);
	virtual ~CBullet_Player_Cube_Main() = default;
...
public:
	static CBullet_Player_Cube_Main* Create();
