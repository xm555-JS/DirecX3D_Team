...
BEGIN(Client)
class CCursor;
class CEnemy_Leviathan_FireBall final : public CBullet_Normal
{
public:
	CEnemy_Leviathan_FireBall();
	CEnemy_Leviathan_FireBall(const CBullet_Normal& rhs);
	virtual ~CEnemy_Leviathan_FireBall() = default;
...
public:
	static CEnemy_Leviathan_FireBall* Create();
