...
class CState_Weaver_Attack_02 : public CState_Boss
{
public:
	CState_Weaver_Attack_02(CState_Manager* pManager, STATE_TYPE eState);
	CState_Weaver_Attack_02(const CState_Weaver_Attack_02& rhs);
	virtual ~CState_Weaver_Attack_02() = default;
...
public:
	static CState_Weaver_Attack_02* Create(CState_Manager* pManager, STATE_TYPE eState);
