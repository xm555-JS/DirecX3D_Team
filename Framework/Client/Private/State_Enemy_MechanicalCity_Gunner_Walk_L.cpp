#include "stdafx.h"
#include "..\Public\State_Enemy_MechanicalCity_Gunner_Walk_L.h"
#include "GameInstance.h"
#include "Enemy.h"
CState_Enemy_MechanicalCity_Gunner_Walk_L::CState_Enemy_MechanicalCity_Gunner_Walk_L(CState_Manager* pManager, STATE_TYPE eState)
	:CState_Enemy_Normal(pManager, eState)
{
}

CState_Enemy_MechanicalCity_Gunner_Walk_L::CState_Enemy_MechanicalCity_Gunner_Walk_L(const CState_Enemy_MechanicalCity_Gunner_Walk_L& rhs)
	: CState_Enemy_Normal(rhs)
{
	m_fRunStartDistance = rhs.m_fRunStartDistance;
}

HRESULT CState_Enemy_MechanicalCity_Gunner_Walk_L::Initialize_Prototype()
{
...
HRESULT CState_Enemy_MechanicalCity_Gunner_Walk_L::Initialize(void* pArg)
{

	return S_OK;
}

void CState_Enemy_MechanicalCity_Gunner_Walk_L::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Enemy_MechanicalCity_Gunner_Walk_L::Tick(_float fTimeDelta)
{
	if (Is_Damaged())
		m_bEndCurState = true;
...
void CState_Enemy_MechanicalCity_Gunner_Walk_L::Exit(void* pArg)
{

}

_bool CState_Enemy_MechanicalCity_Gunner_Walk_L::Check_Condition(CState_Handler* pHandler)
{
...
CState_Enemy_MechanicalCity_Gunner_Walk_L* CState_Enemy_MechanicalCity_Gunner_Walk_L::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Enemy_MechanicalCity_Gunner_Walk_L* pInstance = new CState_Enemy_MechanicalCity_Gunner_Walk_L(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Enemy_MechanicalCity_Gunner_Walk_L");
...
CState* CState_Enemy_MechanicalCity_Gunner_Walk_L::Clone(void* pArg)
{
	CState_Enemy_MechanicalCity_Gunner_Walk_L* pInstance = new CState_Enemy_MechanicalCity_Gunner_Walk_L(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Enemy_MechanicalCity_Gunner_Walk_L");
		Safe_Release(pInstance);
	}
...
void CState_Enemy_MechanicalCity_Gunner_Walk_L::Free()
{
	__super::Free();
}
