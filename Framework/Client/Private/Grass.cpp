...
HRESULT CGrass::Initialize(void* pArg)
{
	...
	FAILEDCHECK(__super::Add_Component(m_iCurLevel, ID_UINT(MODEL_STATIC, MODEL_GRASS, iID.tNums.Num2, iID.tNums.Num3), ID_UINT(MODEL_STATIC), (CComponent**)&m_pModelCom));
...
HRESULT CGrass::SetUp_ShaderResource()
{
...
void CGrass::Input_Key(_float fTimeDelta)
{
}

HRESULT CGrass::SetUp_Model(ID_UINT iPrototypeID)
{
	/* For.Com_Model */
...
CGrass* CGrass::Create()
{
	CGrass* pInstance = new CGrass();
