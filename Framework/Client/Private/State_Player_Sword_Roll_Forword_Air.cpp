#include "stdafx.h"
#include "..\Public\State_Player_Sword_Roll_Forword_Air.h"
...
CState_Player_Sword_Roll_Forword_Air::CState_Player_Sword_Roll_Forword_Air(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player(pManager, eState)
{
}

CState_Player_Sword_Roll_Forword_Air::CState_Player_Sword_Roll_Forword_Air(const CState_Player_Sword_Roll_Forword_Air& rhs)
	: CState_Player(rhs)
{
}

HRESULT CState_Player_Sword_Roll_Forword_Air::Initialize_Prototype()
{
...
HRESULT CState_Player_Sword_Roll_Forword_Air::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_Sword_Roll_Forword_Air::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Player_Sword_Roll_Forword_Air::Tick(_float fTimeDelta)
{
...
void CState_Player_Sword_Roll_Forword_Air::Exit(void* pArg)
{
	CTransform* pPlayerTransform = (CTransform*)m_pState_Handler->Get_Player()->Get_Component(TRANSFORM);
...
_bool CState_Player_Sword_Roll_Forword_Air::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
...
CState_Player_Sword_Roll_Forword_Air* CState_Player_Sword_Roll_Forword_Air::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_Sword_Roll_Forword_Air* pInstance = new CState_Player_Sword_Roll_Forword_Air(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_Sword_Roll_Forword_Air");
...
CState* CState_Player_Sword_Roll_Forword_Air::Clone(void* pArg)
{
	CState_Player_Sword_Roll_Forword_Air* pInstance = new CState_Player_Sword_Roll_Forword_Air(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_Sword_Roll_Forword_Air");
		Safe_Release(pInstance);
	}
...
void CState_Player_Sword_Roll_Forword_Air::Free()
{
}
