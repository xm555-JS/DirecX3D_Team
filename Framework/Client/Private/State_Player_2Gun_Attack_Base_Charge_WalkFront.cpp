#include "stdafx.h"
#include "..\Public\State_Player_2Gun_Attack_Base_Charge_WalkFront.h"
...
CState_Player_2Gun_Attack_Base_Charge_WalkFront::CState_Player_2Gun_Attack_Base_Charge_WalkFront(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player(pManager, eState)
{
}

CState_Player_2Gun_Attack_Base_Charge_WalkFront::CState_Player_2Gun_Attack_Base_Charge_WalkFront(const CState_Player_2Gun_Attack_Base_Charge_WalkFront& rhs)
	: CState_Player(rhs)
{
}

HRESULT CState_Player_2Gun_Attack_Base_Charge_WalkFront::Initialize_Prototype()
{
...
HRESULT CState_Player_2Gun_Attack_Base_Charge_WalkFront::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_2Gun_Attack_Base_Charge_WalkFront::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Player_2Gun_Attack_Base_Charge_WalkFront::Tick(_float fTimeDelta)
{
	USEGAMEINSTANCE;
...
void CState_Player_2Gun_Attack_Base_Charge_WalkFront::Exit(void* pArg)
{
	m_pColCom = ((CCollider*)m_pState_Handler->Get_Player()->Get_Component(ID_UINT(COLLIDER, COLLIDER_SPHERE, COL_PLAYER_ATTACK)));
	__super::Exit();
}

_bool CState_Player_2Gun_Attack_Base_Charge_WalkFront::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
	if (KEY_PRESSING('W') &&
...
CState_Player_2Gun_Attack_Base_Charge_WalkFront* CState_Player_2Gun_Attack_Base_Charge_WalkFront::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_2Gun_Attack_Base_Charge_WalkFront* pInstance = new CState_Player_2Gun_Attack_Base_Charge_WalkFront(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_2Gun_Attack_Base_Charge_WalkFront");
...
CState* CState_Player_2Gun_Attack_Base_Charge_WalkFront::Clone(void* pArg)
{
	CState_Player_2Gun_Attack_Base_Charge_WalkFront* pInstance = new CState_Player_2Gun_Attack_Base_Charge_WalkFront(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_2Gun_Attack_Base_Charge_WalkFront");
		Safe_Release(pInstance);
	}
...
void CState_Player_2Gun_Attack_Base_Charge_WalkFront::Free()
{
}
