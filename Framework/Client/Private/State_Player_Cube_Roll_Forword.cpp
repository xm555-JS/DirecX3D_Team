#include "stdafx.h"
#include "..\Public\State_Player_Cube_Roll_Forword.h"
...
CState_Player_Cube_Roll_Forword::CState_Player_Cube_Roll_Forword(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player(pManager, eState)
{
}

CState_Player_Cube_Roll_Forword::CState_Player_Cube_Roll_Forword(const CState_Player_Cube_Roll_Forword& rhs)
	: CState_Player(rhs)
{
}

HRESULT CState_Player_Cube_Roll_Forword::Initialize_Prototype()
{
...
HRESULT CState_Player_Cube_Roll_Forword::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_Cube_Roll_Forword::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Player_Cube_Roll_Forword::Tick(_float fTimeDelta)
{
	USEGAMEINSTANCE;
...
void CState_Player_Cube_Roll_Forword::Exit(void* pArg)
{
	__super::Exit();
}

_bool CState_Player_Cube_Roll_Forword::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
...
CState_Player_Cube_Roll_Forword* CState_Player_Cube_Roll_Forword::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_Cube_Roll_Forword* pInstance = new CState_Player_Cube_Roll_Forword(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_Cube_Roll_Forword");
...
CState* CState_Player_Cube_Roll_Forword::Clone(void* pArg)
{
	CState_Player_Cube_Roll_Forword* pInstance = new CState_Player_Cube_Roll_Forword(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_Cube_Roll_Forword");
		Safe_Release(pInstance);
	}
...
void CState_Player_Cube_Roll_Forword::Free()
{
}
