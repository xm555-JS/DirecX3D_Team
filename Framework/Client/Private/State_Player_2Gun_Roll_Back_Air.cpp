#include "stdafx.h"
#include "..\Public\State_Player_2Gun_Roll_Back_Air.h"
...
CState_Player_2Gun_Roll_Back_Air::CState_Player_2Gun_Roll_Back_Air(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player(pManager, eState)
{
}

CState_Player_2Gun_Roll_Back_Air::CState_Player_2Gun_Roll_Back_Air(const CState_Player_2Gun_Roll_Back_Air& rhs)
	: CState_Player(rhs)
{
}

HRESULT CState_Player_2Gun_Roll_Back_Air::Initialize_Prototype()
{
...
HRESULT CState_Player_2Gun_Roll_Back_Air::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_2Gun_Roll_Back_Air::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Player_2Gun_Roll_Back_Air::Tick(_float fTimeDelta)
{
...
void CState_Player_2Gun_Roll_Back_Air::Exit(void* pArg)
{
	CTransform* pPlayerTransform = (CTransform*)m_pState_Handler->Get_Player()->Get_Component(TRANSFORM);
	pPlayerTransform->Set_YFixState(false);
	__super::Exit();
...
_bool CState_Player_2Gun_Roll_Back_Air::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
...
CState_Player_2Gun_Roll_Back_Air* CState_Player_2Gun_Roll_Back_Air::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_2Gun_Roll_Back_Air* pInstance = new CState_Player_2Gun_Roll_Back_Air(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_2Gun_Roll_Back_Air");
...
CState* CState_Player_2Gun_Roll_Back_Air::Clone(void* pArg)
{
	CState_Player_2Gun_Roll_Back_Air* pInstance = new CState_Player_2Gun_Roll_Back_Air(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_2Gun_Roll_Back_Air");
		Safe_Release(pInstance);
	}
...
void CState_Player_2Gun_Roll_Back_Air::Free()
{
}
