#include "stdafx.h"
#include "..\Public\State_Player_Skate_Run_Swerve_R.h"
...
CState_Player_Skate_Run_Swerve_R::CState_Player_Skate_Run_Swerve_R(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player_Skate(pManager, eState)
{
}

CState_Player_Skate_Run_Swerve_R::CState_Player_Skate_Run_Swerve_R(const CState_Player_Skate_Run_Swerve_R& rhs)
	: CState_Player_Skate(rhs)
{
}

HRESULT CState_Player_Skate_Run_Swerve_R::Initialize_Prototype()
{
...
HRESULT CState_Player_Skate_Run_Swerve_R::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_Skate_Run_Swerve_R::Enter(void* pArg)
{
	//202
	__super::Enter(pArg);
...
void CState_Player_Skate_Run_Swerve_R::Tick(_float fTimeDelta)
{
...
void CState_Player_Skate_Run_Swerve_R::Exit(void* pArg)
{
...
_bool CState_Player_Skate_Run_Swerve_R::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
	if (KEY_PRESSING('D') &&
...
CState_Player_Skate_Run_Swerve_R* CState_Player_Skate_Run_Swerve_R::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_Skate_Run_Swerve_R* pInstance = new CState_Player_Skate_Run_Swerve_R(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_Skate_Run_Swerve_R");
...
CState* CState_Player_Skate_Run_Swerve_R::Clone(void* pArg)
{
	CState_Player_Skate_Run_Swerve_R* pInstance = new CState_Player_Skate_Run_Swerve_R(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_Skate_Run_Swerve_R");
		Safe_Release(pInstance);
	}
...
void CState_Player_Skate_Run_Swerve_R::Free()
{
}
