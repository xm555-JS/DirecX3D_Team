#include "stdafx.h"
#include "..\Public\State_Enemy_HyenaGang_Shooter_Attack_Normal_Shot.h"
#include "GameInstance.h"
#include "Enemy.h"
#include "HIerarchyNode.h"
#include "Enemy_Arrow.h"

CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot(CState_Manager* pManager, STATE_TYPE eState)
	:CState_Enemy_Normal(pManager, eState)
{
}

CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot(const CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot& rhs)
	: CState_Enemy_Normal(rhs)
{
}

HRESULT CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Initialize_Prototype()
{
...
HRESULT CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Initialize(void * pArg)
{
	return S_OK;
}

void CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Tick(_float fTimeDelta)
{
	if (Is_Damaged())
		m_bEndCurState = true;
...
void CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Exit(void* pArg)
{

}

_bool CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Check_Condition(CState_Handler* pHandler)
{
...
CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot* CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot* pInstance = new CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot");
...
CState* CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Clone(void* pArg)
{
	CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot* pInstance = new CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot");
		Safe_Release(pInstance);
	}
...
void CState_Enemy_HyenaGang_Shooter_Attack_Normal_Shot::Free()
{
	__super::Free();
}
