#include "stdafx.h"
#include "..\Public\State_Player_2Gun_Attack_Base_Charge_WalkBack.h"
...
CState_Player_2Gun_Attack_Base_Charge_WalkBack::CState_Player_2Gun_Attack_Base_Charge_WalkBack(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player(pManager, eState)
{
}

CState_Player_2Gun_Attack_Base_Charge_WalkBack::CState_Player_2Gun_Attack_Base_Charge_WalkBack(const CState_Player_2Gun_Attack_Base_Charge_WalkBack& rhs)
	: CState_Player(rhs)
{
}

HRESULT CState_Player_2Gun_Attack_Base_Charge_WalkBack::Initialize_Prototype()
{
	...
	m_ForceStates.push_back(STATE_PLAYER_IDLE);
...
HRESULT CState_Player_2Gun_Attack_Base_Charge_WalkBack::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_2Gun_Attack_Base_Charge_WalkBack::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Player_2Gun_Attack_Base_Charge_WalkBack::Tick(_float fTimeDelta)
{
	USEGAMEINSTANCE;
...
void CState_Player_2Gun_Attack_Base_Charge_WalkBack::Exit(void* pArg)
{
	m_pColCom = ((CCollider*)m_pState_Handler->Get_Player()->Get_Component(ID_UINT(COLLIDER, COLLIDER_SPHERE, COL_PLAYER_ATTACK)));
	__super::Exit();
}

_bool CState_Player_2Gun_Attack_Base_Charge_WalkBack::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
	if (KEY_PRESSING('S') &&
...
CState_Player_2Gun_Attack_Base_Charge_WalkBack* CState_Player_2Gun_Attack_Base_Charge_WalkBack::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_2Gun_Attack_Base_Charge_WalkBack* pInstance = new CState_Player_2Gun_Attack_Base_Charge_WalkBack(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_2Gun_Attack_Base_Charge_WalkBack");
...
CState* CState_Player_2Gun_Attack_Base_Charge_WalkBack::Clone(void* pArg)
{
	CState_Player_2Gun_Attack_Base_Charge_WalkBack* pInstance = new CState_Player_2Gun_Attack_Base_Charge_WalkBack(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_2Gun_Attack_Base_Charge_WalkBack");
		Safe_Release(pInstance);
	}
...
void CState_Player_2Gun_Attack_Base_Charge_WalkBack::Free()
{
}
