#include "stdafx.h"
#include "..\Public\Weapon_Stic.h"

#include "GameInstance.h"
#include "HIerarchyNode.h"
#include "Unit.h"

CWeapon_Stic::CWeapon_Stic()
	: CWeapon()
{

}

CWeapon_Stic::CWeapon_Stic(const CWeapon_Stic & rhs)
	: CWeapon(rhs)
{

}

HRESULT CWeapon_Stic::Initialize_Prototype()
{

	return S_OK;
}

HRESULT CWeapon_Stic::Initialize(void * pArg)
{
	USEGAMEINSTANCE;
...
void CWeapon_Stic::Tick(_float fTimeDelta)
{
...
void CWeapon_Stic::LateTick(_float fTimeDelta)
{
...
HRESULT CWeapon_Stic::SetUp_Components()
{
	CWeapon::SetUp_Components();
	/* For.Com_Shader */
	FAILEDCHECK(__super::Add_Component(m_iCurLevel, ID_UINT(MODEL_STATIC, MODEL_WEAPON, MODEL_ENEMY_WEAPON_STIC), ID_UINT(MODEL_STATIC), (CComponent**)&m_pModelCom));
...
//HRESULT CWeapon_Stic::SetUp_ShaderResource()
//{
//	if (nullptr == m_pShaderCom)
//		return E_FAIL;
//
...
CWeapon_Stic* CWeapon_Stic::Create()
{
	CWeapon_Stic*		pInstance = new CWeapon_Stic();

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CWeapon_Stic");		
...
CGameObject * CWeapon_Stic::Clone(void * pArg)
{
	CWeapon_Stic*		pInstance = new CWeapon_Stic(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CWeapon_Stic");
		Safe_Release(pInstance);
	}
