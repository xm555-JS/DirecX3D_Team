#include "stdafx.h"
#include "..\Public\State_Player_Skate_Run_Swerve_L.h"
...
CState_Player_Skate_Run_Swerve_L::CState_Player_Skate_Run_Swerve_L(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player_Skate(pManager, eState)
{
}

CState_Player_Skate_Run_Swerve_L::CState_Player_Skate_Run_Swerve_L(const CState_Player_Skate_Run_Swerve_L& rhs)
	: CState_Player_Skate(rhs)
{
}

HRESULT CState_Player_Skate_Run_Swerve_L::Initialize_Prototype()
{
...
HRESULT CState_Player_Skate_Run_Swerve_L::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_Skate_Run_Swerve_L::Enter(void* pArg)
{
	//201
	__super::Enter(pArg);
...
void CState_Player_Skate_Run_Swerve_L::Tick(_float fTimeDelta)
{
...
void CState_Player_Skate_Run_Swerve_L::Exit(void* pArg)
{
	m_fKeyPressTimeAcc = 0.f;
	__super::Exit();
}

_bool CState_Player_Skate_Run_Swerve_L::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
	if (KEY_PRESSING('A') &&
...
CState_Player_Skate_Run_Swerve_L* CState_Player_Skate_Run_Swerve_L::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_Skate_Run_Swerve_L* pInstance = new CState_Player_Skate_Run_Swerve_L(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_Skate_Run_Swerve_L");
...
CState* CState_Player_Skate_Run_Swerve_L::Clone(void* pArg)
{
	CState_Player_Skate_Run_Swerve_L* pInstance = new CState_Player_Skate_Run_Swerve_L(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_Skate_Run_Swerve_L");
		Safe_Release(pInstance);
	}
...
void CState_Player_Skate_Run_Swerve_L::Free()
{
}
