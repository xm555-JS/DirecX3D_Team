#include "stdafx.h"
#include "..\Public\State_Enemy_HyenaGang_Shooter_Walk.h"
#include "GameInstance.h"
#include "Enemy.h"

CState_Enemy_HyenaGang_Shooter_Walk::CState_Enemy_HyenaGang_Shooter_Walk(CState_Manager* pManager, STATE_TYPE eState)
	:CState_Enemy_Normal(pManager, eState)
{
}

CState_Enemy_HyenaGang_Shooter_Walk::CState_Enemy_HyenaGang_Shooter_Walk(const CState_Enemy_HyenaGang_Shooter_Walk& rhs)
	: CState_Enemy_Normal(rhs)
{
}

HRESULT CState_Enemy_HyenaGang_Shooter_Walk::Initialize_Prototype()
{
...
HRESULT CState_Enemy_HyenaGang_Shooter_Walk::Initialize(void * pArg)
{

	return S_OK;
}

void CState_Enemy_HyenaGang_Shooter_Walk::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Enemy_HyenaGang_Shooter_Walk::Tick(_float fTimeDelta)
{
...
void CState_Enemy_HyenaGang_Shooter_Walk::Exit(void* pArg)
{

}

_bool CState_Enemy_HyenaGang_Shooter_Walk::Check_Condition(CState_Handler* pHandler)
{
...
CState_Enemy_HyenaGang_Shooter_Walk* CState_Enemy_HyenaGang_Shooter_Walk::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Enemy_HyenaGang_Shooter_Walk* pInstance = new CState_Enemy_HyenaGang_Shooter_Walk(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Enemy_HyenaGang_Shooter_Walk");
...
CState* CState_Enemy_HyenaGang_Shooter_Walk::Clone(void* pArg)
{
	CState_Enemy_HyenaGang_Shooter_Walk* pInstance = new CState_Enemy_HyenaGang_Shooter_Walk(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Enemy_HyenaGang_Shooter_Walk");
		Safe_Release(pInstance);
	}
...
void CState_Enemy_HyenaGang_Shooter_Walk::Free()
{
	__super::Free();
}
