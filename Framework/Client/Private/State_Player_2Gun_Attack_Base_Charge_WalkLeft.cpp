#include "stdafx.h"
#include "..\Public\State_Player_2Gun_Attack_Base_Charge_WalkLeft.h"
...
CState_Player_2Gun_Attack_Base_Charge_WalkLeft::CState_Player_2Gun_Attack_Base_Charge_WalkLeft(CState_Manager* pManager, STATE_TYPE eState)
	: CState_Player(pManager, eState)
{
}

CState_Player_2Gun_Attack_Base_Charge_WalkLeft::CState_Player_2Gun_Attack_Base_Charge_WalkLeft(const CState_Player_2Gun_Attack_Base_Charge_WalkLeft& rhs)
	: CState_Player(rhs)
{
}

HRESULT CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Initialize_Prototype()
{
...
HRESULT CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Initialize(void* pArg)
{
	return S_OK;
}

void CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Enter(void* pArg)
{
	__super::Enter(pArg);
...
void CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Tick(_float fTimeDelta)
{
	USEGAMEINSTANCE;
...
void CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Exit(void* pArg)
{
	m_pColCom = ((CCollider*)m_pState_Handler->Get_Player()->Get_Component(ID_UINT(COLLIDER, COLLIDER_SPHERE, COL_PLAYER_ATTACK)));
	__super::Exit();
}

_bool CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Check_Condition(CState_Handler* pHandler)
{
	USEGAMEINSTANCE;
	if (KEY_PRESSING('A') &&
...
CState_Player_2Gun_Attack_Base_Charge_WalkLeft* CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Create(CState_Manager* pManager, STATE_TYPE eState)
{
	CState_Player_2Gun_Attack_Base_Charge_WalkLeft* pInstance = new CState_Player_2Gun_Attack_Base_Charge_WalkLeft(pManager, eState);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CState_Player_2Gun_Attack_Base_Charge_WalkLeft");
...
CState* CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Clone(void* pArg)
{
	CState_Player_2Gun_Attack_Base_Charge_WalkLeft* pInstance = new CState_Player_2Gun_Attack_Base_Charge_WalkLeft(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CState_Player_2Gun_Attack_Base_Charge_WalkLeft");
		Safe_Release(pInstance);
	}
...
void CState_Player_2Gun_Attack_Base_Charge_WalkLeft::Free()
{
}
